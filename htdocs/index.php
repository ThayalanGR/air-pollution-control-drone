...
$ret=mysqli_query($DB,"SELECT * FROM admin WHERE name='$adminusername' and password='$pass'");
  ...
  <body>
	  <div id="login-page">
	  	<div class="container">      
            ...
            <a class="btn btn-theme btn-block" href="./register.php">Apctmd Registration</a>
		      </form>	  	
	  	</div>
	  </div>
